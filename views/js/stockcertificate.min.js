'use strict';var createStockCertificate=function(){var b=id("investor-name").value,f=id("investor-wallet").value,a=id("company-name").value,c=id("transfer-agent").value,d=id("state-of-incorporation").value,g=id("cusip").value,h=id("isin").value,e=id("share-type").value,k=id("par-value").value,l=id("issue-date").value,m=id("share-qty").value,n=id("share-price").value,p=id("officer-1").value,q=id("officer-title-1").value,r=id("officer-2").value,t=id("officer-title-2").value;return`<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
    <html>
    <head>
    ...
    ${b} OR IN SUCH OTHER NAME AS IS REQUESTED BY AN
    AUTHORIZED REPRESENTATIVE OF </span></span></span></font></font></font></span><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="1" style="font-size: 8pt"><span style="letter-spacing: normal"><span lang="en-US"><span style="font-style: normal"><span style="font-weight: normal">${f}</span></span></span></span></font></font></font></span><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="1" style="font-size: 8pt"><span style="letter-spacing: normal"><span style="font-style: normal"><span style="font-weight: normal">
    ...
    AS MUCH AS THE REGISTERED OWNER HEREOF, ${b}, HAS AN
    ...
    <p class="western" align="center" style="orphans: 2; widows: 2"><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><span style="letter-spacing: normal"><span style="font-style: normal"><span style="font-weight: normal">${a}</span></span></span></font></font></span></p>
    ...
    State of ${d}</span></span></span></font></font></span></p>
    <center>
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="46%" valign="top" style="border: none; padding: 0in"><p class="western" align="left" style="orphans: 0; widows: 0">
                    CUSIP: <font color="#000000"><font size="3" style="font-size: 12pt"><span lang="en-US">${g}</span></font></font></p>
                </td>
            ...
            <tr>
                ...
                <td width="53%" valign="top" style="border: none; padding: 0in"><p class="western" align="right" style="orphans: 0; widows: 0">
                    <font face="Liberation Serif, serif"><font size="3" style="font-size: 12pt">${e}</font></font></p>
                </td>
            </tr>
        </table>
    </center>
    ...
    is to certify that </span></span></span></font></font></font></span><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="2" style="font-size: 10pt"><span style="letter-spacing: normal"><span lang="en-US"><span style="font-style: normal"><span style="font-weight: normal">${b}</span></span></span></span></font></font></font></span><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="2" style="font-size: 10pt"><span style="letter-spacing: normal"><span style="font-style: normal"><span style="font-weight: normal">
    is the registered owner of </span></span></span></font></font></font></span><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="2" style="font-size: 10pt"><span style="letter-spacing: normal"><span style="font-style: normal"><span style="font-weight: normal">${m}</span></span></span></font></font></font></span><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="2" style="font-size: 10pt"><span style="letter-spacing: normal"><span style="font-style: normal"><span style="font-weight: normal">
    shares of fully paid and non-assessable ${e},
    ${k} par value and a stated amount of ${n} per
    share of ${a}, a ${d} corporation
    ...
    ${l}</span></span></span></font></font></span></p>
    <p class="western" align="left" style="orphans: 2; widows: 2"><span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><font size="1" style="font-size: 8pt"><span style="letter-spacing: normal"><span style="font-style: normal"><span style="font-weight: normal">${a}</span></span></span></font></font></font></span></p>
    ...
    ${p}					 	Name: ${r}</span></span></span></font></font></font></span></p>
    ...
    ${q}						Title: ${t}</span></span></span></font></font></font></span></p>
    ...
    <p class="western" align="left" style="line-height: 115%"><font size="1" style="font-size: 8pt">${c}</font></p>
    <p class="western" align="left" style="line-height: 115%"><br/>
    ...
    <span style="font-variant: normal"><font color="#000000"><font face="Times New Roman, serif"><span style="letter-spacing: normal"><span style="font-style: normal"><b>${a}</b></span></span></font></font></span></p>
